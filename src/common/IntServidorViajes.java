...
public interface IntServidorViajes extends Remote {
    ...
    public void registrarNotificacion(String origen, IntCallbackCliente cliente) throws RemoteException, IOException, ParseException;
    public void borrarNotificacion(String origen, IntCallbackCliente cliente) throws RemoteException, IOException, ParseException;
}
